...
export default function Example() {
  ...
  return (
    <div className="">
      <header className="absolute inset-x-0 top-0 z-50 top-nav">
        <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
          <div className="flex lg:flex-1 top-nav2">
          ...
          <div className="hidden lg:flex lg:gap-x-12 tap4">
            {navigation.map((item) => (
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end tap4">
          ...
          <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            ...
            <div className="mt-6 flow-root">
              <div className="-my-6 divide-y divide-gray-500/10">
                <div className="space-y-2 py-6 tap4">
                  {navigation.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
