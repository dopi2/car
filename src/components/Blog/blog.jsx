...
export function BlogSection11() {
  return (
    <section className=" mx-auto px-8 py-10 lg:py-28 pity">
      <Typography
        variant="h2"
        color="blue-gray"
        className="!text-2xl !leading-snug lg:!text-3xl damnt"
      >
        Build something great
      </Typography>
      <Typography
        variant="lead"
        className="mt-2 max-w-lg !font-normal !text-white tapp"
      >
      ...
      <div className="mt-10 grid grid-cols-1 gap-10 lg:grid-cols-3 " id="dope">
